...
function PxLoaderVideo(a, b, c, d) {
    ...
    void 0 !== d && (this.img.crossOrigin = d), this.tags = b, this.priority = c;
    var h = function () {
...
!function (a) {
    function b(a) {
        ...
        var k = function (a, b) {
            ...
            if (null != m && m.status === g.WAITING) for (m.status = b, f = Date.now(), i = a.tags.length, c = 0, h = e.length; h > c; c++) j = e[c], k = 0 === j.tags.length ? !0 : a.tags.intersects(j.tags), k && l(m, j)
        };
