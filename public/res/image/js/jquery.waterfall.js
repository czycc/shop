...
(function($) {
    var $window = $(window),
        ...
        defaults = {
            ...
            spacingWidth: 1, // the brick element horizontal spacing
            spacingHeight: 1, // the brick element vertical spacing
            minColCount: 3, // min columns
            resizeable: true, // trigger positionAll() when browser window is resized
