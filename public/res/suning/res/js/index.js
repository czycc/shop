$(function(){
    ...
    function init_loading(){
        ...
        for(var i = 0; i < 201; i++){
            if(i < 10){
                frame_arr3.push('../res/suning/res/images/frame5/1_0000'+ i + '.jpg');
            }else if(i < 100){
                frame_arr3.push('../res/suning/res/images/frame5/1_000'+ i + '.jpg');
            }else if(i < 1000){
                frame_arr3.push('../res/suning/res/images/frame5/1_00'+ i + '.jpg');
            }
        }
        var fileList= [];
